...
def user_messages
  Users::Messages.new(message_subject: 'fake')
end
...
def participant_message_1
  Participants::Messages.new(message_subject: 'Reply: I like this app')
end
...
def participant_message_2
  Participants::Messages.new(message_subject: 'Testing compose functionality')
end
...
def user_message_6
  Users::Messages.new(message_subject: 'Try out the LEARN tool')
end

def user_message_7
  Users::Messages.new(message_subject: 'Check out the Introduction slideshow')
end
