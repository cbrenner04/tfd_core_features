...
module Participants
  module FeelModules
    ...
    class TrackingMoodEmotions
      ...
      def rate_emotion(emotion:, type:, rating:)
        select emotion, from: 'emotional_rating_emotion_id'
        select type, from: 'emotional_rating_is_positive'
        select rating, from: 'emotional_rating[rating]'
      end

      def add_and_rate_emotion(emotion:, type:, rating:)
