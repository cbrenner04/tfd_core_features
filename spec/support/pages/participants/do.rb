...
module Participants
  ...
  class DoTool
    ...
    def landing_page
      "#{ENV['Base_URL']}/navigator/contexts/DO"
    end

    def awareness
      "#{ENV['Base_URL']}/navigator/modules/339588004"
    end
    ...
    def navigate_to_all_modules_through_nav_bar
      tools = ['#2 Planning', '#1 Awareness', 'View Planned Activities',
               '#3 Doing', 'Add a New Activity', 'Your Activities', 'DO Home']
      contents = ['The last few times you were here...',
